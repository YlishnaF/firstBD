...
public class Child extends DBIntro{

    public static void main(String[] args) {

        JSONArray responsePeople = handler.executeSQLRequest("SELECT * FROM peopleandpets.people");

        JSONArray responsePeopleANdPets =handler.executeSQLRequest("SELECT peopleandpets.people.name, peopleandpets.people.location, peopleandpets.people.birthday, peopleandpets.animals.pet_name, peopleandpets.animals.type,peopleandpets.animals.pet_birthday\n" +
        ...
        ReadContext ctx2 = parse(responsePeopleANdPets);
        ...
        ReadContext ctx = parse(responsePeople);
